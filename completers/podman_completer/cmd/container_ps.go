...
func init() {
	...
	container_psCmd.Flags().IntP("last", "n", -1, "Print the n last created containers (all states)")
	...
	container_psCmd.Flags().UintP("watch", "w", 0, "Watch the ps output on an interval in seconds")
