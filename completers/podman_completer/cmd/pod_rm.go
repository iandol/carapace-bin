...
func init() {
	...
	pod_rmCmd.Flags().StringArray("pod-id-file", []string{}, "Read the pod ID from the file")
	pod_rmCmd.Flags().UintP("time", "t", 10, "Seconds to wait for pod stop before killing the container")
