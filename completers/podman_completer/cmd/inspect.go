...
func init() {
	...
	inspectCmd.Flags().StringP("format", "f", "json", "Format the output to a Go template or json")
	...
	inspectCmd.Flags().StringP("type", "t", "all", "Specify inspect-object type (\"image\", \"container\" or \"all\")")
