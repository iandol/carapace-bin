...
func init() {
	...
	container_runlabelCmd.Flags().BoolP("pull", "p", true, "Pull the image if it does not exist locally prior to executing the label contents")
	...
	container_runlabelCmd.Flags().Bool("tls-verify", true, "Require HTTPS and verify certificates when contacting registries")
